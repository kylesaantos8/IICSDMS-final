...
public class MyNotifRecyclerViewAdapter extends RecyclerView.Adapter<MyNotifRecyclerViewAdapter.ViewHolder> {
    ...
    public MyNotifRecyclerViewAdapter(FragmentManager fm, ArrayList<NotifPojo> inbox, Context ctx, String linkSeenUpdate, String logEmail){
        this.inbox = inbox;
        this.ctx = ctx;
        this.fm = fm;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewHolder viewHolder = new ViewHolder(view, ctx, inbox, fm);
        return viewHolder;
    }
...
//        holder.mItemPage.setText(notif.getNotifPage());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(View view, Context ctx, ArrayList<NotifPojo> inbox, FragmentManager fm) {
        ...
        public void onClick(View v) {
            ...
            if(notifPojo.getNotifPage() != null)
            {
                ...
                {
                    Toast.makeText(this.ctx, "Please visit IICS DMS Web to view the content.", Toast.LENGTH_LONG).show();
                }
            }
